...
# Introduction
React basic project showing how to make an asynchronous CRUD operation over the network.
This belongs to my projects that aim to show full stack development, see below for more apps to learn from.
From this project you will learn:
- React: state, properties, components, modal
- Pagination
- Axios, Superagent as network http clients
...
# TODO
- Replace the react-bootstrap dialog with vanilla only react
