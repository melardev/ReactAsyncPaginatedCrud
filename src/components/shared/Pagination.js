                ...
                <li className="page-item" data-toggle="tooltip" data-placement="top" title="Go to last page">
                    <a className="page-link"
                       onClick={e => this.props.loadMore({
                           page: this.props.pageMeta.number_of_pages,
                           page_size: this.props.pageMeta.requested_page_size
                       })}>
        ...
        if (this.props.pageMeta.current_page_number >= 3) {
            return (
                (<li className="page-item" data-toggle="tooltip" data-placement="top" title="Go to first page">
                    <a className="page-link"
                       onClick={e => this.props.loadMore({page: 1, page_size: this.props.pageMeta.requested_page_size})}>
                        1
                    </a>
                </li>));
        }
                        ...
                        <ul className="pagination">
                            ...
                            (<li className="page-item" data-toggle="tooltip" data-placement="top"
                                ...
                                <span className="page-link"
                                      onClick={e => this.props.loadMore({
                                          page: this.props.pageMeta.prev_page_number,
                                          page_size: this.props.pageMeta.requested_page_size
                                      })}>
                            ...
                            <li className="page-item">
                                <a className="page-link"
                                   onClick={e => this.props.loadMore({
                                       page: this.props.pageMeta.next_page_number,
                                       page_size: this.props.pageMeta.requested_page_size
                                   })}>
